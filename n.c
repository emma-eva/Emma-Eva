...
#define keyword_end 95
 ...
 array array_slice(array s, int start, int _end) {
     ...
     array res = (array) {
         .element_size = s.element_size, .data = s.data + start * s.element_size, .len = l, .cap = l
     };
 ...
 string string_clone(string a) {
     ...
     string b = (string) {
         .len = a.len, .str = v_malloc(a.len + 1)
     };
 ...
 string string_add(string s, string a) {
     ...
     string res = (string) {
         .len = new_len, .str = v_malloc(new_len + 1)
     };
 ...
 ustring string_ustring(string s) {
     ...
     ustring res = (ustring) {
         .s = s, .runes = new_array(0, s.len, sizeof(int)), .len = 0
     };
 ...
 map new_map(int cap, int elm_size) {
     ...
     map res = (map) {
         .element_size = elm_size, .entries = new_array(0, 1, sizeof(Entry)), .is_sorted = 0
     };
 ...
 Entry map_new_entry(map * m, string key, void * val) {
     ...
     Entry new_e = (Entry) {
         .key = key, .val = v_malloc(m -> element_size)
     };
 ...
 smap new_smap() {
     ...
     smap res = (smap) {
         .entries = new_array(0, 1, sizeof(Entry2)), .is_sorted = 0
     };
 ...
 StringBuilder new_string_builder(int initial_size) {
     ...
     return (StringBuilder) {
         .buf = new_array(0, initial_size, sizeof(byte)), .len = 0
     };
 ...
 os__File os__create_file2(string file, string mode) {
     ...
     os__File res = (os__File) {
         .cfile = fopen(string_cstr(file), string_cstr(mode))
     };
 ...
 time__Time time__now() {
     ...
     time__Time res = (time__Time) {
         .year = 0, .day = 0, .month = 0, .hour = 0, .minute = 0, .second = 0, .uni = 0
     };
 ...
 time__Time time__random() {
     ...
     return (time__Time) {
         .year = rand__next(2) + 201, .month = rand__next(12) + 1, .day = rand__next(30) + 1, .hour = rand__next(24), .minute = rand__next(60), .second = rand__next(60), .uni = 0
     };
 ...
 time__Time time__convert_ctime(struct tm t) {
     ...
     return (time__Time) {
         .year = t.tm_year + 1900, .month = t.tm_mon + 1, .day = t.tm_mday, .hour = t.tm_hour, .minute = t.tm_min, .second = t.tm_sec, .uni = 0
     };
 ...
 time__Time time__parse(string s) {
     ...
     return time__new_time((time__Time) {
         .year = string_int(( * (string * ) array__get(ymd, 0))), .month = string_int(( * (string * ) array__get(ymd, 1))), .day = string_int(( * (string * ) array__get(ymd, 2))), .hour = string_int(hour), .minute = string_int(minute), .second = string_int(second), .uni = 0
     });
 ...
 time__Time time__new_time(time__Time t) {
     ...
     return (time__Time) {
         .uni = time__Time_calc_unix( & /* ? */ t), .year = t.year, .day = t.day, .month = t.month, .hour = t.hour, .minute = t.minute, .second = t.second,
     };
 ...
 CGen * new_cgen(string out_name_c) {
     ...
     CGen * gen = ALLOC_INIT(CGen, {
         .out_path = _STR("%.*s/%.*s", main__TmpPath.len, main__TmpPath.str, out_name_c.len, out_name_c.str),
         .out = os__create_file(_STR("%.*s/%.*s", main__TmpPath.len, main__TmpPath.str, out_name_c.len, out_name_c.str)),
 ...
 Var Fn_find_var(Fn * f, string name) {
     ...
     return (Var) {
         .typ = tos("", 0), .name = tos("", 0), .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
     };
 ...
 void Fn_register_var(Fn * f, Var v) {
     ...
     Var new_var = (Var) {
         .scope_level = f -> scope_level, .typ = v.typ, .name = v.name, .is_arg = v.is_arg, .is_const = v.is_const, .is_import_const = v.is_import_const, .args = v.args, .attr = v.attr, .is_mut = v.is_mut, .ptr = v.ptr, .ref = v.ref, .parent_fn = v.parent_fn, .pkg = v.pkg, .line_nr = v.line_nr, .access_mod = v.access_mod, .is_global = v.is_global, .is_used = v.is_used,
     };
 ...
 void Parser_fn_decl(Parser * p) {
     ...
     if (p -> tok == LPAR) {
         ...
         Var receiver = (Var) {
             .name = receiver_name, .is_arg = 1, .typ = receiver_typ, .is_mut = is_mut, .ref = is_amp, .ptr = is_mut, .line_nr = p -> scanner -> line_nr, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .parent_fn = tos("", 0), .pkg = tos("", 0), .is_global = 0, .is_used = 0, .scope_level = 0
         };
     ...
     if (string_ne(receiver_typ, tos2(""))) {
         ...
         if (Parser_first_run( & /* ? */ * p) && string_eq(receiver_T -> name, tos2(""))) {
             ...
             Type ttyp = (Type) {
                 .name = string_replace(receiver_typ, tos2("*"), tos2("")), .pkg = p -> pkg, .is_placeholder = 1, .fields = new_array(0, 1, sizeof(Var)), .methods = new_array(0, 1, sizeof(Fn)), .parent = tos("", 0), .gen_types = new_array(0, 1, sizeof(string)), .is_c = 0, .is_interface = 0, .is_enum = 0,
             };
     ...
     for (int tmp51 = 0; tmp51 < tmp50.len; tmp51++) {
         ...
         if (!
             var.is_used && !
             var.is_arg && !p -> translated && string_ne(var.name, tos2("_"))) {
             /*if*/

             p -> scanner -> line_nr =
                 var.line_nr - 1;

             Parser_error(p, _STR("`%.*s` declared and not used",
                 var.name.len,
                 var.name.str));
 ...
 void Parser_fn_args(Parser * p, Fn * f) {
     ...
     if (f -> is_interface) {
         ...
         Var int_arg = (Var) {
             .typ = f -> receiver_typ, .name = tos("", 0), .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
         };
     ...
     if (types_only) {
         ...
         while (p -> tok != RPAR) {
             ...
             Var v = (Var) {
                 .typ = typ, .is_arg = 1, .line_nr = p -> scanner -> line_nr, .name = tos("", 0), .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .is_global = 0, .is_used = 0, .scope_level = 0
             };
     ...
     while (p -> tok != RPAR) {
         ...
         array_string names = new_array_from_c_array(1, 1, sizeof(string), (string[]) {
             Parser_check_name(p)
         });
         ...
         for (int tmp80 = 0; tmp80 < tmp79.len; tmp80++) {
             ...
             Var v = (Var) {
                 .name = name, .typ = typ2, .is_arg = 1, .is_mut = is_mut, .ptr = is_mut, .line_nr = p -> scanner -> line_nr, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .is_global = 0, .is_used = 0, .scope_level = 0
             };
         ...
         if (p -> tok == DOTDOT) {
             ...
             _PUSH( & f -> args, ((Var) {
                 .name = tos2(".."), .typ = tos("", 0), .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
             }), tmp83, Var);
 ...
 void Parser_gen_json_for_type(Parser * p, Type typ) {
     ...
     Fn dec_fn = (Fn) {
         .pkg = p -> pkg, .typ = _STR("Option_%.*s", typ.name.len, typ.name.str), .name = js_dec_name(t), .local_vars = new_array(0, 1, sizeof(Var)), .var_idx = 0, .args = new_array(0, 1, sizeof(Var)), .is_interface = 0, .scope_level = 0, .is_c = 0, .receiver_typ = tos("", 0), .is_private = 0, .is_method = 0, .returns_error = 0, .is_decl = 0, .defer = tos("", 0)
     };
     ...
     Var arg = (Var) {
         .typ = tos2("cJSON*"), .name = tos("", 0), .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
     };
     ...
     Fn enc_fn = (Fn) {
         .pkg = p -> pkg, .typ = tos2("cJSON*"), .name = js_enc_name(t), .local_vars = new_array(0, 1, sizeof(Var)), .var_idx = 0, .args = new_array(0, 1, sizeof(Var)), .is_interface = 0, .scope_level = 0, .is_c = 0, .receiver_typ = tos("", 0), .is_private = 0, .is_method = 0, .returns_error = 0, .is_decl = 0, .defer = tos("", 0)
     };

     Var enc_arg = (Var) {
         .typ = t, .name = tos("", 0), .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
     };
 ...
 bool is_js_prim(string typ) {
     ...
     return string_eq(typ, tos2("int")) || string_eq(typ, tos2("string")) || string_eq(typ, tos2("bool")) || string_eq(typ, tos2("float")) || string_eq(typ, tos2("f32")) || string_eq(typ, tos2("f64")) || string_eq(typ, tos2("i8")) || string_eq(typ, tos2("i16")) || string_eq(typ, tos2("i32")) || string_eq(typ, tos2("i64"));
 ...
 string vtmp_path() {
     ...
     return string_add(os__home_dir(), tos2("/.n/"));
 ...
 void V_compile(V * c) {
     ...
     CGen_genln(cgen, tos2("// Generated by NEO - 15/05/2023"));
 ...
 void V_cc(V * c) {
     ...
     array_string a = new_array_from_c_array(1, 1, sizeof(string), (string[]) {
         tos2("-w")
     });
     ...
     if (c -> os == LINUX && !linux_host) {
         ...
         _PUSH( & a, (_STR("-c --sysroot=%.*s -target x86_64-linux-gnu", sysroot.len, sysroot.str)), tmp33, string);
     ...
     _PUSH( & a, (_STR("%.*s/%.*s", main__TmpPath.len, main__TmpPath.str, c -> out_name_c.len, c -> out_name_c.str)), tmp35, string);
 ...
 array_string V_v_files_from_dir(V * c, string dir) {
     ...
     for (int tmp50 = 0; tmp50 < tmp49.len; tmp50++) {
         ...
         _PUSH( & res, (_STR("%.*s/%.*s", dir.len, dir.str, file.len, file.str)), tmp52, string);
 ...
 V * new_v(array_string args) {
     ...
     if (string_eq(target_os, tos2(""))) {
         ...
         if (string_eq(target_os, tos2("linux"))) {
             /* case */

             _os = LINUX;

         } else if (string_eq(target_os, tos2("windows"))) {
             /* case */

             _os = WINDOWS;

         } else if (string_eq(target_os, tos2("mac"))) {
             /* case */
     ...
     array_string builtins = new_array_from_c_array(9, 9, sizeof(string), (string[]) {
         tos2("array.v"), tos2("string.v"), tos2("builtin.v"), tos2("int.v"), tos2("utf8.v"), tos2("map.v"), tos2("smap.v"), tos2("option.v"), tos2("string_builder.v"),
     });
 ...
 array_string run_repl() {
     ...
     while (1) {
         ...
         if (string_starts_with(line, tos2("print"))) {
             ...
             V * v = new_v(new_array_from_c_array(3, 3, sizeof(string), (string[]) {
                 tos2("v"), tos2("-repl"), file
             }));
 ...
 Parser V_new_parser(V * c, string path, Pass run) {
     ...
     Parser p = (Parser) {
         .file_path = path, .file_name = string_all_after(path, tos2("/")), .scanner = new_scanner(path), .table = c -> table, .cur_fn = main__EmptyFn, .cgen = c -> cgen, .is_test = c -> is_test, .is_script = ( /*lpar*/ c -> is_script && string_eq(path, c -> dir)), .is_so = c -> is_so, .os = c -> os, .is_prof = c -> is_prof, .is_prod = c -> is_prod, .is_play = c -> is_play, .translated = c -> translated, .obfuscate = c -> obfuscate, .is_verbose = c -> is_verbose, .build_mode = c -> build_mode, .is_repl = c -> is_repl, .run = run, .vroot = c -> vroot, .token_idx = 0, .lit = tos("", 0), .pkg = tos("", 0), .inside_const = 0, .assigned_type = tos("", 0), .tmp_cnt = 0, .is_live = 0, .builtin_pkg = 0, .vh_lines = new_array(0, 1, sizeof(string)), .inside_if_expr = 0, .is_struct_init = 0, .if_expr_cnt = 0, .for_expr_cnt = 0, .ptr_cast = 0, .calling_c = 0, .returns = 0,
     };
 ...
 void Parser_parse(Parser * p) {
     ...
     while (1) {
         ...
         } else if ((p -> tok == STRUCT) || (p -> tok == INTERFACE) || (p -> tok == UNION) || (p -> tok == LSBR)) {
             /* case */
         ...
         } else if ((p -> tok == DOLLAR)) {
             /* case */

             Parser_comp_time(p);

         } else if ((p -> tok == GLOBAL)) {
             /* case */
 ...
 void Parser_struct_decl(Parser * p) {
     ...
     while (p -> tok != RCBR) {
         ...
         if (is_interface) {
             ...
             Fn * interface_method = ALLOC_INIT(Fn, {
                 .name = field_name,
                 .is_interface = 1,
                 .is_method = 1,
                 .receiver_typ = name,
             ...
             println(_STR("is interfaace. field=%.*s run=%d", field_name.len, field_name.str, p -> run));
 ...
 void Parser_enum_decl(Parser * p, string _enum_name) {
     ...
     Table_register_type2(p -> table, * ALLOC_INIT(Type, {
         .name = enum_name,
         .pkg = p -> pkg,
         .parent = tos2("int"),
         .is_enum = 1,
 ...
 string Parser_get_type(Parser * p) {
     ...
     if (p -> tok == FUNC) {
         ...
         Fn f = (Fn) {
             .name = tos2("_"), .pkg = p -> pkg, .local_vars = new_array(0, 1, sizeof(Var)), .var_idx = 0, .args = new_array(0, 1, sizeof(Var)), .is_interface = 0, .scope_level = 0, .typ = tos("", 0), .is_c = 0, .receiver_typ = tos("", 0), .is_private = 0, .is_method = 0, .returns_error = 0, .is_decl = 0, .defer = tos("", 0)
         };
         ...
         Type fn_typ = (Type) {
             .name = Fn_typ_str(f), .pkg = p -> pkg, .func = f, .fields = new_array(0, 1, sizeof(Var)), .methods = new_array(0, 1, sizeof(Fn)), .parent = tos("", 0), .gen_types = new_array(0, 1, sizeof(string)), .is_c = 0, .is_interface = 0, .is_enum = 0, .is_placeholder = 0
         };
 ...
 string Parser_statement(Parser * p, bool add_semi) {
     ...
     } else if ((tok == SWITCH) || (tok == MATCH)) {
         /* case */

         Parser_switch_statement(p);

     } else if ((tok == MUT) || (tok == STATIC)) {
         /* case */
 ...
 void Parser_var_decl(Parser * p) {
     ...
     Parser_register_var(p, (Var) {
         .name = name, .typ = typ, .is_mut = is_mut, .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
     });
 ...
 string Parser_name_expr(Parser * p) {
     ...
     if (is_c) {
         ...
         Fn f = (Fn) {
             .name = name, .is_c = 1, .pkg = tos("", 0), .local_vars = new_array(0, 1, sizeof(Var)), .var_idx = 0, .args = new_array(0, 1, sizeof(Var)), .is_interface = 0, .scope_level = 0, .typ = tos("", 0), .receiver_typ = tos("", 0), .is_private = 0, .is_method = 0, .returns_error = 0, .is_decl = 0, .defer = tos("", 0)
         };
 ...
 string Parser_assoc(Parser * p) {
     ...
     Type * T = Table_find_type( & /* ? */ * p -> table,
         var.typ);
 ...
 string Parser_typ_to_fmt(Parser * p, string typ) {
     ...
     } else if (string_eq(typ, tos2("ustring"))) {
         /* case */

         return tos2("%.*s");

     } else if (string_eq(typ, tos2("long"))) {
         /* case */
     ...
     } else if (string_eq(typ, tos2("char"))) {
         /* case */
     ...
     } else if (string_eq(typ, tos2("bool"))) {
         /* case */

         return tos2("%d");

     } else if (string_eq(typ, tos2("u32"))) {
         /* case */

         return tos2("%d");

     } else if (string_eq(typ, tos2("float"))) {
         /* case */

         return tos2("%f");

     } else if (string_eq(typ, tos2("double")) || string_eq(typ, tos2("f64"))) {
         /* case */
     ...
     } else if (string_eq(typ, tos2("void"))) {
         /* case */
 ...
 string os_name_to_ifdef(string name) {
     ...
     if (string_eq(name, tos2("windows"))) {
         /* case */

         return tos2("_WIN32");

     } else if (string_eq(name, tos2("mac"))) {
         /* case */

         return tos2("__APPLE__");

     } else if (string_eq(name, tos2("linux"))) {
         /* case */
 ...
 void Parser_for_st(Parser * p) {
     ...
     if (p -> tok == LCBR) {
         ...
         Var val_var = (Var) {
             .name = val, .typ = var_typ, .ptr = string_contains(typ, tos2("*")), .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
         };

         Parser_register_var(p, val_var);

         Var i_var = (Var) {
             .name = i, .typ = tos2("int"), .is_mut = 1, .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
         };
         ...
         Var val_var = (Var) {
             .name = val, .typ = var_type, .ptr = string_contains(typ, tos2("*")), .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
         };
 ...
 Scanner * new_scanner(string file_path) {
     ...
     Scanner * scanner = ALLOC_INIT(Scanner, {
         .file_path = file_path,
 ...
 string Scanner_ident_number(Scanner * s) {
     ...
     while (1) {
         ...
         bool is_good_hex = is_hex && ( /*lpar*/ c == 'x' || c == 'u' || ( /*lpar*/ c >= 'a' && c <= 'f'));
 ...
 string Scanner_get_until_start(Scanner * s, int pos) {
     ...
     for (; pos_start < pos && ( /*lpar*/ string_at(s -> text, pos_start) == ' ' || string_at(s -> text, pos_start) == '\n'); pos_start++) {
 ...
 string Fn_str(Fn f) {
     ...
     Table t = (Table) {
         .types = new_array(0, 1, sizeof(Type)), .consts = new_array(0, 1, sizeof(Var)), .fns = new_array(0, 1, sizeof(Fn)), .packages = new_array(0, 1, sizeof(string)), .imports = new_array(0, 1, sizeof(string)), .flags = new_array(0, 1, sizeof(string)), .fn_cnt = 0, .obfuscate = 0
     };
 ...
 void Table_register_const(Table * t, string name, string typ, string pkg, bool is_imported) {
     ...
     _PUSH( & t -> consts, ((Var) {
         .name = name, .typ = typ, .is_const = 1, .is_import_const = is_imported, .pkg = pkg, .is_arg = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
     }), tmp10, Var);

 }
 void Parser_register_global(Parser * p, string name, string typ) {

     _PUSH( & p -> table -> consts, ((Var) {
         .name = name, .typ = typ, .is_const = 1, .is_global = 1, .pkg = p -> pkg, .is_arg = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .attr = tos("", 0), .is_mut = 0, .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .line_nr = 0, .is_used = 0, .scope_level = 0
     }), tmp11, Var);
 ...
 Fn Table_find_fn(Table * t, string name) {
     ...
     return (Fn) {
         .pkg = tos("", 0), .local_vars = new_array(0, 1, sizeof(Var)), .var_idx = 0, .args = new_array(0, 1, sizeof(Var)), .is_interface = 0, .scope_level = 0, .typ = tos("", 0), .name = tos("", 0), .is_c = 0, .receiver_typ = tos("", 0), .is_private = 0, .is_method = 0, .returns_error = 0, .is_decl = 0, .defer = tos("", 0)
     };
 ...
 void Table_register_type(Table * t, string typ) {
     ...
     Type datyp = (Type) {
         .name = typ, .pkg = tos("", 0), .fields = new_array(0, 1, sizeof(Var)), .methods = new_array(0, 1, sizeof(Fn)), .parent = tos("", 0), .gen_types = new_array(0, 1, sizeof(string)), .is_c = 0, .is_interface = 0, .is_enum = 0, .is_placeholder = 0
     };
 ...
 void Parser_register_type_with_parent(Parser * p, string strtyp, string parent) {
     ...
     Type typ = (Type) {
         .name = strtyp, .parent = parent, .pkg = p -> pkg, .fields = new_array(0, 1, sizeof(Var)), .methods = new_array(0, 1, sizeof(Fn)), .gen_types = new_array(0, 1, sizeof(string)), .is_c = 0, .is_interface = 0, .is_enum = 0, .is_placeholder = 0
     };
 ...
 void Table_register_type_with_parent(Table * t, string typ, string parent) {
     ...
     Type datyp = (Type) {
         .name = typ, .parent = parent, .pkg = tos("", 0), .fields = new_array(0, 1, sizeof(Var)), .methods = new_array(0, 1, sizeof(Fn)), .gen_types = new_array(0, 1, sizeof(string)), .is_c = 0, .is_interface = 0, .is_enum = 0, .is_placeholder = 0
     };
 ...
 void Type_add_field(Type * t, string name, string typ, bool is_mut, string attr, AccessMod access_mod) {
     ...
     Var v = (Var) {
         .name = name, .typ = typ, .is_mut = is_mut, .attr = attr, .access_mod = access_mod, .is_arg = 0, .is_const = 0, .is_import_const = 0, .args = new_array(0, 1, sizeof(Var)), .ptr = 0, .ref = 0, .parent_fn = tos("", 0), .pkg = tos("", 0), .line_nr = 0, .is_global = 0, .is_used = 0, .scope_level = 0
     };
 ...
 bool Parser__check_types(Parser * p, string got, string expected, bool
     ...
     if (string_ne(got, expected)) {
         ...
         if (string_ends_with(expected, tos2("er"))) {
             ...
             if (Parser_satisfies_interface(p, expected, got,
                     throw)) {
                 /*if*/
 ...
 void init_consts() {
     ...
     main__SupportedPlatforms = new_array_from_c_array(3, 3, sizeof(string), (string[]) {
         tos2("windows"), tos2("mac"), tos2("linux")
     });
     main__TmpPath = vtmp_path();
     main__EmptyFn = ALLOC_INIT(Fn, {
         .pkg = tos("", 0),
         .local_vars = new_array(0, 1, sizeof(Var)),
         .var_idx = 0,
         .args = new_array(0, 1, sizeof(Var)),
     ...
     main__CReserved = new_array_from_c_array(10, 10, sizeof(string), (string[]) {
         tos2("exit"), tos2("unix"), tos2("print"), tos2("error"), tos2("malloc"), tos2("calloc"), tos2("char"), tos2("free"), tos2("panic"), tos2("register")
     });
     main__NUMBER_TYPES = new_array_from_c_array(16, 16, sizeof(string), (string[]) {
         tos2("number"), tos2("int"), tos2("i8"), tos2("u8"), tos2("i16"), tos2("u16"), tos2("i32"), tos2("u32"), tos2("byte"), tos2("i64"), tos2("u64"), tos2("long"), tos2("double"), tos2("float"), tos2("f32"), tos2("f64")
     });
     main__FLOAT_TYPES = new_array_from_c_array(4, 4, sizeof(string), (string[]) {
         tos2("double"), tos2("float"), tos2("f32"), tos2("f64")
     });
     main__TOKENSTR = build_token_str();
     main__KEYWORDS = build_keys();
     main__AssignTokens = new_array_from_c_array(11, 11, sizeof(Token), (Token[]) {
         ASSIGN,
         PLUS_ASSIGN,
         MINUS_ASSIGN,
         MULT_ASSIGN,
